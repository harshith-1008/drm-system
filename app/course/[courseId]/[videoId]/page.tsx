    ...
    <div className="min-h-screen bg-[#020817] text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Lesson Timeline */}
          <div>
            <h2 className="text-2xl font-semibold mb-6">Introduction to UI/UX</h2>
              ...
              <div className="space-y-4">
                {lessons.map((lesson, index) => (
                  <div key={index} className="relative pl-8 py-2">
                    ...
                    />
                    <div className={`${index === 0 ? "text-white" : "text-gray-500"}`}>{lesson.title}</div>
...
const lessons = [
  ...
  { title: "Overview of design tools (Figma, Adobe XD, Sketch)", duration: "2hrs" },
]
